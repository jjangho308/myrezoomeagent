...
//
//public class IORequestJobAction_bak extends AbstractJob<IORequestJobEntity> {
//
...
//
//      // database
//      Map<String, Object> dbResultEntityListMap = ManagerProvider.job().getAgentIORequest().getData(entity);
