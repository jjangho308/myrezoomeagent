...
public interface Jsonable {
	 ...
	 * 
	 */
	// class Converter implements JsonSerializer<Jsonable>,
	// JsonDeserializer<Jsonable> {
	//
	// /**
	// * Singleton Helper. <br />
	// *
	...
	//
	// @Override
	// public Jsonable deserialize(JsonElement json, Type typeOfT,
	...
	// throw new JsonParseException("Cannot institate " + typeOfT.getTypeName(),
	// e);
	// }
	// List<Field> fields =
	// Arrays.asList(typeOfT.getClass().getDeclaredFields());
	//
	// //
	// Map<String, Field> keyMap = new HashMap<String, Field>();
	// for (Field field : fields) {
	// SerializedName serializedName =
	// field.getDeclaredAnnotation(SerializedName.class);
	// if (serializedName != null) {
	// String keyName = serializedName.value();
	// if (keyMap.containsKey(keyName)) {
	// throw new JsonParseException("Serialized name of " + field.getName() + "
	// field is duplicated.");
	// }
	...
	// try {
	// target.set(object, context.deserialize(entry.getValue(),
	// target.getClass()));
	...
	//
	// @Override
	// public JsonElement serialize(Jsonable src, Type typeOfSrc,
	...
	// ? field.getDeclaredAnnotation(SerializedName.class).value() :
	// field.getName();
	//
	// // Field actual value.
	...
	// field.getType().asSubclass(Jsonable.class) != null) {
	// JsonObject interfaceObject = (JsonObject)
	// context.serialize(field.get(src));
	...
	// JsonObject elementJsonObject = (JsonObject)
	// context.serialize(mapValue.get(key));
	...
	//
	// else {
	// element.add(fieldJsonKey, context.serialize(fieldValue,
	// field.getType()));
	// }
	// }
